...
async function main() {
    ...
    console.log(`Storage Cost: ${Number(storageCost) / FROST_TO_WAL} WAL`);
    console.log(`Write Cost: ${Number(writeCost) / FROST_TO_WAL} WAL`);
    console.log(`Total Cost: ${Number(totalCost) / FROST_TO_WAL} WAL`);
    ...
    console.log(`Storage Cost: ${Number(smallStorageCost) / FROST_TO_WAL} WAL`);
    console.log(`Write Cost: ${Number(smallWriteCost) / FROST_TO_WAL} WAL`);
    console.log(`Total Cost: ${Number(smallTotalCost) / FROST_TO_WAL} WAL`);
}
